export default {
    ...
    intro2:"本次上市前試玩資源來自光榮特庫摩遊戲提供，使用 PS5 版本。這篇不包含細部、轉折劇情雷點，僅針對遊戲內容分享。內容偏向職業系統、戰鬥與角色養成等設計，整體結構相對單純，比較像是《FF》系列的衍生或是實驗作品；目前已知 次世代主機 PS5、Xbox Series X|S 存在較好的視覺體驗。"
}
